...
router.get('/', function(req, res, next) {
    let a = []
    Axios.get(`https://open.neis.go.kr/hub/mealServiceDietInfo?KEY=0fdf1d1c60aa4905a6587398591425a7&Type=json&ATPT_OFCDC_SC_CODE=J10&SD_SCHUL_CODE=7530336&MLSV_YMD=${time}`)
